    ...
    >
      <div class="upgrade-title">
        <div class="upgrade-title-warp">
          <span class="upgrade-title-warp-txt">{{ $t("layout.upgrade.title") }}</span>
          <span class="upgrade-title-warp-version">v{{ state.version }}</span>
        </div>
      </div>
      <div class="upgrade-content">
        {{ getThemeConfig.globalTitle }} {{ $t("layout.upgrade.msg") }}
        <div class="mt5">
          <el-link
            type="primary"
            class="font12"
        ...
        <div class="upgrade-content-desc mt5">{{ $t("layout.upgrade.desc") }}</div>
      </div>
...
const onUpgrade = () => {
  ...
  state.btnTxt = t("layout.upgrade.btnTwoLoading");
  setTimeout(() => {
    Local.clear();
...
onMounted(() => {
  // delayShow();
  setTimeout(() => {
    state.btnTxt = t("layout.upgrade.btnTwo");
  }, 200);
});
</script>
