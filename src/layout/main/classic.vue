...
.layout-container {
  --next-bg-menuBar: #fff;
  --next-bg-menuBarColor: var(--el-text-color-primary);
  --next-bg-menuBarHover: var(--el-color-primary-light-9);
  --next-bg-menuBarActiveColor: var(--el-color-primary-light-9);
}
</style>
