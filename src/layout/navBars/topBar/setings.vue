<template>
  <div class="layout-breadcrumb-seting">
    <el-drawer
      :title="$t('layout.layout.configTitle')"
    ...
    >
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        <!-- 全局主题 -->
        <el-divider content-position="left">{{ $t("layout.layout.oneTitle") }}</el-divider>
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsDark") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <!-- 顶栏设置 -->
        <el-divider content-position="left">{{ $t("layout.layout.twoTopTitle") }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoTopBar") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoTopBarColor") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt10">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoIsTopBarColorGradual") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <!-- 菜单设置 -->
        <el-divider content-position="left">{{ $t("layout.layout.twoMenuTitle") }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoMenuBar") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoMenuBarColor") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoMenuBarActiveColor") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoIsMenuBarColorGradual") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        >
          {{ $t("layout.layout.twoColumnsTitle") }}
        </el-divider>
        <div
          class="layout-breadcrumb-seting-bar-flex"
          :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoColumnsMenuBar") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div
          ...
          :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoColumnsMenuBarColor") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-color-picker
        ...
        <div
          ...
          :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoIsColumnsMenuBarColorGradual") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div
          ...
          :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.twoIsColumnsMenuHoverPreload") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <!-- 界面设置 -->
        <el-divider content-position="left">{{ $t("layout.layout.threeTitle") }}</el-divider>
        <div
          class="layout-breadcrumb-seting-bar-flex"
          :style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.threeIsCollapse") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div
          ...
          :style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.threeIsUniqueOpened") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.threeIsFixedHeader") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.threeIsClassicSplitMenu") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.threeIsLockScreen") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt11">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.threeLockScreenTime") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-input-number
        ...
        <!-- 界面显示 -->
        <el-divider content-position="left">{{ $t("layout.layout.fourTitle") }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsShowLogo") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsBreadcrumb") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsBreadcrumbIcon") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsTagsview") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsTagsviewIcon") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsCacheTagsView") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsSortableTagsView") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsShareTagsView") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsFooter") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsGrayscale") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsInvert") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourIsWartermark") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt14">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fourWartermarkText") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-input
        ...
        <!-- 其它设置 -->
        <el-divider content-position="left">{{ $t("layout.layout.fiveTitle") }}</el-divider>
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fiveTagsStyle") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fiveAnimation") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
        ...
        <div
          ...
          :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fiveColumnsAsideStyle") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
        ...
        <div
          ...
          :style="{ opacity: getThemeConfig.layout !== 'columns' ? 0.5 : 1 }"
        >
          <div class="layout-breadcrumb-seting-bar-flex-label">{{ $t("layout.layout.fiveColumnsAsideLayout") }}</div>
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-select
        ...
        <!-- 布局切换 -->
        <el-divider content-position="left">{{ $t("layout.layout.sixTitle") }}</el-divider>
        <div class="layout-drawer-content-flex">
          ...
          >
            ...
            >
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t("layout.layout.sixDefaults") }}</p>
              </div>
            </div>
          </div>
          <!-- classic 布局 -->
          ...
          >
            ...
            >
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t("layout.layout.sixClassic") }}</p>
              </div>
            </div>
          </div>
          <!-- transverse 布局 -->
          ...
          >
            ...
            >
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t("layout.layout.sixTransverse") }}</p>
              </div>
            </div>
          </div>
          <!-- columns 布局 -->
          ...
          >
            ...
            >
              <div class="layout-tips-box">
                <p class="layout-tips-txt">{{ $t("layout.layout.sixColumns") }}</p>
              </div>
            </div>
          </div>
        </div>
...
const onColorPickerChange = () => {
  if (getThemeConfig.value.primary && getThemeConfig.value.primary === "default") {
    return;
  }
