<template>
  <el-container>
    <el-header class="el-page-header">
      ...
      <el-button
        type="primary"
        @click="openFormHandle"
      >
        {{ $t("form.statistics.openFormHandle") }}
      </el-button>
    </el-header>
    <el-main>
      <el-table
      ...
      >
        ...
        <el-table-column
          :label="$t('form.statistics.serialNumber')"
          prop="serialNumber"
        />
        <el-table-column
          :label="$t('form.statistics.submitAddress')"
          prop="submitAddress"
        />
        <el-table-column
          :label="$t('form.statistics.submitTime')"
          prop="createTime"
        />
      </el-table>
    </el-main>
...
import ResultItem from "./item.vue";
...
export default {
  ...
  metaInfo: {
    title: i18n.global.t("form.statistics.result"),
    meta: [
      {
        name: "viewport",
