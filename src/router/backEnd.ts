...
import { dynamicRoutes, fixedRoutes, notFoundAndNoPower } from "@/router/route";
...
/**
 * 处理路由格式及添加捕获所有路由或 404 Not found 路由n
 ...
 * 添加前台的动态路由
 */
export async function setAddFrontRoute() {
  let filterRouteEnd: any = formatTwoStageRoutes(formatFlatteningRoutes([dynamicRoutes[1]]));
